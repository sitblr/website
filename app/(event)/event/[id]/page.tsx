  ...
  return (
    ...
    <div className="h-full">
      ...
      {/* <div className="text-center p-4 mt-10">
              ...
              <h3 className="text-xl py-2 dark:text-white md:text-xl">
                Developer and designer.
              </h3>
              <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200 max-w-xs mx-auto md:text-sm">
      ...
      {/* <div class="max-w-sm rounded overflow-hidden shadow-lg">
            <div className="mx-auto bg-gradient-to-b from-teal-500 rounded-full relative overflow-hidden mt-4 md:h-[200px] md:w-[200px]">
              ...
              <div class="px-6 pt-4 pb-2">
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#CAP</span>
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#RAP</span>
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#ABAP</span>
              </div>
            </div> */}
      ...
      {/* <div className="text-center p-10 py-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-md mx-auto md:text-sm">
              Freelancer providing services for programming and design content
              needs. Join me down below and let's get cracking!
            </p>
            <div className="mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 relative overflow-hidden mt-20 md:h-[200px] md:w-[200px]">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-sm mx-auto md:text-sm">
              Freelancer providing services for programming and design content
              needs. Join me down below and let's get cracking!
            </p>
            <div className="mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 relative overflow-hidden mt-20  md:h-[200px] md:w-[200px]">
