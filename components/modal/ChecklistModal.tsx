            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <ol className="list-decimal p-2 text-left">
                        ...
                        </li><li>The venue spans across buildings BLR05 Ground Floor <a target="_blank" className="decoration-blue-500 underline underline-offset-auto text-blue-600" href="../../data/map/1stfloor.png">(MAP)</a> and First Floor <a target="_blank" className="decoration-blue-500 underline underline-offset-auto text-blue-600" href="https://goo.gl/maps/9kHzt9qpNMSpvhmB7">(MAP)</a>. There will be volunteers to guide you throughout the event. Please feel free to navigate from one session to another regardless of the track.
