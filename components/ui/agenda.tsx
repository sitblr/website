    ...
    <div>
      <div className="mx-auto max-w-screen-xl">
        ...
        <div id="lecture-sessions">
          <h2 className="text-3xl font-bold my-4 text-sky-900">Lecture Sessions</h2>
        ...
        <div id="demo-pods">
          <h2 className="text-3xl font-bold my-4  text-sky-900">Demo Pods</h2>
          {/* Add content for Demo Pods here */}
        </div>

        <div id="hands-on">
          <h2 className="text-3xl font-bold my-4  text-sky-900">Hands-on</h2>
